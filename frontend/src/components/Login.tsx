...
export default function Login(props: {
  ...
  async function submitPassword() {
    ...
    try {
      ...
      if (r.mfaRequired) {
        ...
        setMsg({ kind: "info", text: "Password accepted. Enter the Secure2u OTP below." });
  ...
  async function submitOtp() {
    ...
    setMsg(null);
    try {
      const r = await api.post<LoginResponse>("/api/auth/verify-otp", { challengeId, code: otp });
  ...
  return (
    <div className="mx-auto max-w-md">
      <ModuleCard title="Module 1 — Login (Authentication)" cwe="CWE-303" sr="SR2">
        <p className="mb-3 text-sm text-gray-600">Please enter your login credentials.</p>
        ...
        {!challengeId && (
          <div className="space-y-3">
            ...
            <div className="rounded border border-dashed border-gray-300 bg-gray-50 p-2 text-xs text-gray-600">
              ...
              <p>
                The seeded password is <code className="font-mono">Password1!</code>. Append extra
                characters and log in:
              </p>
              <ul className="ml-4 mt-1 list-disc">
                <li>
                  <b>Secure OFF</b>: the correct password + junk still logs in (truncated match).
                </li>
                <li>
                  <b>Secure ON</b>: the full password is compared exactly — junk is rejected.
                </li>
              </ul>
              <button onClick={appendJunk} className="mt-1 text-[var(--cimb-red)] underline">
        ...
        <div className="mt-4 text-xs text-gray-500">
          Demo accounts: <b>harry / Password1!</b> (customer) &nbsp;·&nbsp;{" "}
          <b>admin / Admin123!</b> (admin)
          <br />
          Mode is currently{" "}
          <b className={props.secure ? "text-green-700" : "text-[var(--cimb-red)]"}>
